 ...
 */
export class MKBundle extends Singleton {
	constructor() {
		super();
	...
	/* --------------- public --------------- */
	/** 事件 */
	event = new EEvent<_MKBundle.EventProtocol>();
	/** bundle列表 */
	...
	/* --------------- private --------------- */
	/** 初始化任务 */
	private _initTask = new ETask(false);
	/** 引擎初始化任务 */
	private _engineInitTask = new ETask(false);
	/** 日志 */
