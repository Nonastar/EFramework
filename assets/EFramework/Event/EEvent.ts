 ...
 */
class EEvent<CT> extends EventTarget {
    /** 事件键 */
     ...
     */
    // @ts-ignore
    off<T extends keyof CT, T2 extends (...argsList: Parameters<CT[T]>) => void>(
        type_: T | T[],
        callback_?: T2,
        target_?: any
    ): void {
     ...
     */
    // @ts-ignore
    has<T extends keyof CT, T2 extends (...argsList: Parameters<CT[T]>) => void>(
        type_: T,
        callback_?: T2,
        target_?: any
    ): boolean {
     ...
     */
    // @ts-ignore
    request<T extends keyof CT, T2 extends Parameters<CT[T]>, T3 extends ReturnType<CT[T]>>(
        type_: T | T[],
        ...args_: T2
    ): Promise<T3>[] {
        if (Array.isArray(type_)) {
